...
public class VWClient : Observer
{
    ...
    public override void OnDataComplete(string url)
    {
        if (active.ContainsKey(url))
        {
            ...
            // Lets send this record so other observers can see this change.
            List<DataRecord> list = new List<DataRecord>();
            list.Add(active[url].record);
            manager.CallDataComplete("INSERT SPECIAL KEYWORDS HERE", list);
            active.Remove(url);
        }
    }
    ...
    public void getCoverage(string jobName, DataRecord Record, string crs = "", string BoundingBox = "", int Width = 0, int Height = 0, string Interpolation = "nearest") // Parameters TODO
    {
    ...
    public void getMap(string jobName, DataRecord record, int Width = 100, int Height = 100, string Format = "image/png") // Parameters TODO
    {
    ...
    public void getFeatures(string jobName, DataRecord record, string Version = "1.0.0") // Parameters TODO
    {
    ...
    public string RequestRecords(string jobName, int offset, int limit, string model_set_type = "vis", string service = "", string query = "", string starttime = "", string endtime = "", string location = "", string state = "", string modelname = "", string timestamp_start = "", string timestamp_end = "", string model_vars = "")
    {
