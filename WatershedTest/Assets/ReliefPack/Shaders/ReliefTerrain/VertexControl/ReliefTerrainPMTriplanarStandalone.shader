...
//
//
Shader "Relief Pack/ReliefTerrainPMTriplanarStandalone" {
	//
...
//		_SplatAtlasA ("Detail atlas (RGB+A spec)", 2D) = "black" {}
		...
		_SplatA0 ("Detailmap 0 (RGB+A spec)", 2D) = "white" {}
		_SplatA1 ("Detailmap 1 (RGB+A spec)", 2D) = "white" {}
		_SplatA2 ("Detailmap 2 (RGB+A spec)", 2D) = "white" {}
		_SplatA3 ("Detailmap 3 (RGB+A spec)", 2D) = "white" {}
