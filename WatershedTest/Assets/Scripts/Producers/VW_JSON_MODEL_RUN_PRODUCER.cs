...
class VW_JSON_MODEL_RUN_Producer : DataProducer
{
    // Fields
    NetworkManager nm;
    VW_JSON_MODEL_RUN_Parser parser = new VW_JSON_MODEL_RUN_Parser();
    
    // Possible constructor
    public VW_JSON_MODEL_RUN_Producer(NetworkManager refToNM)
    {
        nm = refToNM;
    }
