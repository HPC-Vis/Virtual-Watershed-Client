...
public class HaversineCoordinateSystem : WorldCoordinateSystem
{
    ...
    public HaversineCoordinateSystem()
        : base()
    {
        Debug.LogError("haversine");
    }
    ...
    public override Vector2 TranslateToWorld(Vector2 UnityCoord)
    {
        ...
        return CoordinateUtils.CalculateProjectedPointHaversine(WorldOrigin, angle, distance);
    }
