Shader "Relief Pack/GeometryBlend_BumpedDiffuseOverlay" {
//
// Tomasz Stobierski 2012 (as done for Michael O. - Manufactura 4K libraries - here we've got geom blend version)
//
Properties {
...
CGPROGRAM
// here I put decal:blend at the end of line
...
struct Input {
	...
	float2 uv_MainTex2;
	float2 uv_BumpMap2;
	// here I added the line below (if your shader doesn't use COLOR semantics already)
	fixed4 color:COLOR;
};
