...
#endif
	fixed4 color 	: COLOR; // RTP - geom blend - vertex color added
};
...
float4 Parallax (float4 texcoords, half3 viewDir, half parallax_damp, inout half tH) // RTP - geom blend - take height value for blending
{
	...
	tH=h; // RTP
	float2 offset = ParallaxOffset1Step (h, _Parallax*parallax_damp, viewDir);
