...
//
Shader "Relief Pack/GeometryBlend_Customizable Shader 2 Layers (PBL)" {
    Properties {
...
*/
		...
		//
/*
		//rtp_snow_strength ("Snow strength", Range(0,2)) = 1 // commented to be controlled globally by ReliefTerrain script
