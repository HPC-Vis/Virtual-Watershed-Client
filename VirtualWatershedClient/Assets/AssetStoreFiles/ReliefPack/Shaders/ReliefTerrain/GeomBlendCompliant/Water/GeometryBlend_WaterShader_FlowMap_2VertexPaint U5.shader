...
//
Shader "Relief Pack/GeometryBlend_WaterShader_FlowMap_2VertexPaint U5-PBL" {
    Properties {
		[LM_Albedo] _Color("Color A", Color) = (0.5,0.5,0.5,1)	
		[LM_MasterTilingOffset] [LM_Albedo] _MainTex("Albedo A", 2D) = "white" {}
		[LM_Glossiness] _Glossiness("Smoothness A", Range(0.0, 1.0)) = 0.0
		[LM_Specular] _SpecColor("Specular color A", Color) = (0.2,0.2,0.2)	
